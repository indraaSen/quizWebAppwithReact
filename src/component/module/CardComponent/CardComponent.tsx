...
const CardComponent = ({
  ...
  return (
    <div>
      {randQuestions.map((opt: any, index: number) => (
        ...
        >
          <CardContent>
            ...
            <FormControl>
              <FormLabel id={`demo-controlled-radio-buttons-group ${index}`}>
                Options
              </FormLabel>
              <RadioGroup
      ...
      <button
        className={`${hideButton} border-solid border-2 border-indigo-600 p-2 w-32 rounded-md bg-blue-700 text-white mb-2`}
        onClick={seeValue}
      >
        submit
      </button>
